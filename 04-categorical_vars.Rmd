...
yields2
```
When "clay" is 1 and "loam" is 0 then we are in the clay category, when "clay" is 0 and "loam" is 1 then we are in the loam category, and if both are 0 we are in the "sand" category. This can be visualised in 3D:
