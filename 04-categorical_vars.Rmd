...
Only the p-values are slightly different because with `lm()` we estimate 3 parameters with all $n$ data, hence the degrees of freedom are 27 in this case:
```{r echo=TRUE}
# p-values
...
This is a more elegant solution than doing bivariate t-tests.
