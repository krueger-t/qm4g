...
1 then we are in the loam category, and if both are 0 we are in the "sand" category. This is visualised in 3D in Figure \@ref(fig:yields3d).

```{r yields3d, echo=FALSE, fig.align='center', fig.cap='3D representation of the dummy coding of the yields dataset.', out.width='88%'}
